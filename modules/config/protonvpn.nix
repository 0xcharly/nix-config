# Adapted from github.com/emmanuelrosa/erosanix.
# https://github.com/emmanuelrosa/erosanix/blob/9370616c610a85a29e7f3a753db584653885e094/modules/protonvpn.nix
{
  config,
  lib,
  ...
...
in {
  ...
  meta.maintainers = with maintainers; [_0xcharly emmanuelrosa];
}

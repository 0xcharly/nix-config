...
JsonObject {
    ...
    property TypographyValues titleTypography: Config.tokens.system.typography.headline
    property TypographyValues bodyTypography: Config.tokens.system.typography.title

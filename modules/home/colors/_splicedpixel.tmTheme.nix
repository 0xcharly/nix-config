...
''
  ...
  <plist version="1.0">
    <dict>
      ...
      <key>uuid</key>
      <string>e4b6ab29-93b0-4a7c-9c1c-6f2f74e9c0d5</string>
      <key>author</key>
      <string>0xcharly</string>
      ...
      <array>
        <dict>
          ...
          <dict>
            ...
            <string>${text}</string>
            <key>caret</key>
            <string>${surface_cursor}</string>
            <key>lineHighlight</key>
            <string>${surface_cursorline}</string>
            <key>misspelling</key>
            <string>${text_error}</string>
            <key>accent</key>
            <string>${accent}</string>
            <key>selection</key>
            <string>${surface_visual}</string>
            <key>activeGuide</key>
            <string>${borders}</string>
            <key>findHighlight</key>
            <string>${surface_search}</string>
            <key>gutterForeground</key>
            <string>${text_lineno}</string>
          </dict>
        </dict>
        <dict>
          <key>name</key>

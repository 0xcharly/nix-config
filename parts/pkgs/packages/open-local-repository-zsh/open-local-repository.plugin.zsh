...
open-local-repository() {
  ...
  local cmd="${TMUX_OPEN_GIT_REPOSITORY_COMMAND:-"command git list -o flat |command ansifilter |command rg '^/' --color=never |command awk '{print \$1}' |command path-strip-prefix \"$gitget_root\" 2> /dev/null"}"
